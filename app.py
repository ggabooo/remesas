...
def pg_conclusiones():
    ...
    hallazgos = [
        ...
        ("Implicacion Econometrica",
         "La cointegracion implica que las series convergen a un equilibrio de largo plazo. Aunque se desvien en el corto plazo, existe una fuerza que las regresa al equilibrio."),
    ...
    <div class="verdict-ok">
      ...
      <div class="verdict-sub" style="font-size:15px;color:{TEXT};max-width:700px;margin:14px auto 0;">
        ...
        Esta evidencia de cointegracion descarta la interpretacion espuria de la relacion entre las remesas y las variables macroeconomicas analizadas.
      </div>
    </div>""", unsafe_allow_html=True)
